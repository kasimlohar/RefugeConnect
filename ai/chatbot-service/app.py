    ...
    try:
        ...
        if detected_language != 'en':
            try:
                ...
                app.logger.error(f"Translation to English failed: {str(e)}")
                translated_message = message  # Use the original message
        ...
        if detected_language != 'en':
            try:
                ...
                app.logger.error(f"Translation to original language failed: {str(e)}")
                final_response = response  # Use the English response
        ...
        try:
            ...
            app.logger.error(f"Failed to log conversation to MongoDB: {str(e)}")
